...
on quality: it's actually quite hard to reach a consistently high quality bar if you're not the product's direct user. so while most stripes weren't external users of the API, engineers heavily invested in dogfooding and putting themselves into the shoes of users. spinning up fake real businesses, building API integrations, printing out integration guides & redlining them, combing through friction logs, etc.

dogfooding wasn't just a ritual, it's how folks built empathy.
---

Slava Akhmechet
Aug 4
I remember this passion for quality in everything-- all hands prep, convergence, docs pms produced, quality of data produced by analytics, design, tpm/bizops spreadsheets, docs (of course docs!), devrel demos, sessions-- just everything. Only way to do that is if everyone really really cares, which Stripes did.
---
